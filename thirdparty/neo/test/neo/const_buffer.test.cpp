...
TEST_CASE("Default construct const_buffer") {
    neo::const_buffer buf;
    CHECK(buf.size() == 0);
    CHECK(buf.data() == nullptr);
}

TEST_CASE("From pointer and size const_buffer") {
...
TEST_CASE("From string literal const_buffer") {
...
TEST_CASE("From mutable buffer const_buffer") {
...
TEST_CASE("From string_view const_buffer") {
    std::string       str = "Hello!";
...
TEST_CASE("From non-char-string_view const_buffer") {
...
TEST_CASE("Convert to string_view const_buffer") {
...
TEST_CASE("Advance a buffer const_buffer") {
...
TEST_CASE("Remove a suffix const_buffer") {
    std::string my_string = "Hello!";
...
TEST_CASE("Get a head/tail const_buffer") {
...
TEST_CASE("Single-buffer sequence const_buffer") {
    std::string       str = "I am a string";
    neo::const_buffer buf{str};
...
TEST_CASE("Buffer literal const_buffer") {
    {
